from flask import Blueprint, session, render_template, flash, url_for, redirect, request
...
def edit(slug):
    ...
    tags_field = request.values.get('tags_field', _laod_tags_field(post))
